...
public class MainActivityTest {
    ...
    public void testActivitySwitch() {
        ...
        // Check that ShowActivity is displayed (text_city_name should be visible)
        onView(withId(R.id.text_city_name)).check(matches(isDisplayed()));
    }

    // TEST 2: Test whether the city name shown in ShowActivity is consistent
    @Test
    public void testCityNameConsistent() {
        ...
        // Check that ShowActivity displays "Edmonton"
        onView(withId(R.id.text_city_name)).check(matches(withText("Edmonton")));
    }

    // TEST 3: Test the back button returns to MainActivity
    @Test
    public void testBackButton() {
        ...
        // Check that we're back on MainActivity (city_list should be visible)
